...
# Source0-md5:	aefd9fda2178acab908707737174a0cd
Patch0:		%{name}-pngminus.patch
Patch1:		http://downloads.sourceforge.net/libpng-apng/%{name}-1.6.14-apng.patch.gz
# Patch1-md5:	39f35cde00159c24b5a10258d8f2c5ce
